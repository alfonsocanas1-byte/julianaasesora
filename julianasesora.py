...
# Estilos CSS optimizados con corrección de color para móviles
st.markdown("""
    <style>
    .stApp {
    ...
    /* Botón de WhatsApp con forzado de color blanco */
    .whatsapp-button {
        display: block;
        width: 100%;
        padding: 15px;
    ...
    /* Asegura que el color no cambie al hacer click o visitar */
